...
public class ChooseDifficulty extends javax.swing.JFrame {
    ...
    public ChooseDifficulty() {
     ...
     private void setupButtonActions() {
       easy.addActionListener(e -> proceedToQuiz("Easy"));
        jButton1.addActionListener(e -> proceedToQuiz("Medium"));
        jButton2.addActionListener(e -> proceedToQuiz("Hard"));
        mix.addActionListener(e -> proceedToQuiz("Shuffle"));
     }
    ...
    private void mixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mixActionPerformed
      ...
      /**
     * Sets the selected difficulty and provides user feedback.
     *
     * @param difficulty The chosen difficulty level.
     */
    private void proceedToQuiz(String difficulty) {
        selectedDifficulty = difficulty;
        JOptionPane.showMessageDialog(this, "Proceeding to quiz with difficulty: " + difficulty, "Proceed", JOptionPane.INFORMATION_MESSAGE);

        // Transition to TakeQuiz class
        TakeQuiz quiz = new TakeQuiz(difficulty, "General", 10); // Example category and duration
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new ChooseDifficulty().setVisible(true));
    }
